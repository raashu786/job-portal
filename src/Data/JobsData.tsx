...
const dropdownData = [
    // { title: "Doctor Type", icon: IconSearch, options: ['Designer', 'Developer', 'Product Manager', 'Marketing Specialist', 'Data Analyst', 'Sales Executive', 'Content Writer', 'Customer Support'] },
  { title: "Doctor Type", icon: IconSearch, options: [
  'General Physician',
  'Pediatrician',
  'Cardiologist',
  'Dermatologist',
