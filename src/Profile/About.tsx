...
const About = () => {
  ...
  return (
    <div>
        ...
        <div className="text-lg sm:text-xl lg:text-2xl font-semibold mb-3 flex justify-between">About </div><div>{edit&&<ActionIcon onClick={handleSave} variant="subtle" color='bright-sun.4' aria-label="Settings" size="lg">
        <div
         ...
         <ActionIcon onClick={handleClick} variant="subtle" color={edit?"red.4":"bright-sun.4"}aria-label="Settings" size="lg">
           <div
                          className="h-8 w-8 flex items-center sm-mx:h-6 text-bold sm-mx:w-6 justify-center bright-mine-shaft-400 shadow-md bg-mine-shaft-800"
                        >
      ...
      /></>:<><div className="text-xs sm:text-xs lg:text-sm text-mine-shaft-300 text-justify">
      {profile?.about}
    </div> </>
      }
      </div>
